...
public class Bz2WikiParser {
	...
	public static void main(String[] args){
		String[] rank = "%s~~~5.4591112566874116E-5~~~".split("~~~");
		System.out.println(rank.length + " " + rank[1]);
	}

	public static Set<String> parser (String args)  {
		// Configure parser.
		try{
			...
			Set<String> setPageNames = new HashSet<>();
			setPageNames.addAll(linkPageNames);
