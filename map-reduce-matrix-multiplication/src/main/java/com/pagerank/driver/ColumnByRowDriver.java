...
import com.pagerank.domain.calculate.ColumnByRowMapper;
import com.pagerank.domain.calculate.ColumnByRowReducer;
...
public class ColumnByRowDriver {
...
public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException{
		...
		// 1st iteration
		for(int i=1;i<=10;i++){
			System.out.println(" === Fix the page rank for iteration ===" + i);
			// Pre processing job 1
			Job calculateJob = Job.getInstance(config, "Calculate page rank iteration = " + i);				
			...
			calculateJob.setMapperClass(ColumnByRowMapper.class);
			calculateJob.setReducerClass(ColumnByRowReducer.class);
			...
			System.out.println(calculateJob.getCounters().findCounter(CounterVariables.SINK_PAGE_RANK).getValue());
